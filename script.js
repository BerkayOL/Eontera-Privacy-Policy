...
const translations = {
  tr: {
    ...
    cardAdsTitle: "Reklam ve analytics yok",
    cardAdsBody: "Reklam SDK'sı, analytics SDK'sı ve izleme katmanı kullanılmaz.",
    cardLocationTitle: "Konum kullanımı sınırlı",
    cardLocationBody: "Yalnızca isteğe bağlı, approximate ve foreground konum kullanılabilir.",
    cardStorageTitle: "Yerel watch-zone verisi",
    cardStorageBody: "Watch-zone verileri cihazda kalır ve app-level encrypted değildir.",
    ...
    subLocationBody:
      "Kullanıcı approximate location izni verirse, bu bilgi yalnızca ISS veya benzeri gökyüzü bağlamı sunan özelliklerde gözlemci bağlamını hesaplamak için kullanılır.",
    subLocationItem1: "Yalnızca approximate (coarse) konum kullanılır.",
    subLocationItem2: "Kullanım foreground ile sınırlıdır; background location yoktur.",
    subLocationItem3: "Ana harita deneyimi için konum izni zorunlu değildir.",
    subLocationItem4: "Kamera kullanılmaz; yönelim sensörleri ve approximate konum yeterlidir.",
    subWatchTitle: "2.2 Watch-zone verileri",
    subWatchBody:
      "Kullanıcı bir watch zone oluşturduğunda seçilen bölge adı, koordinatlar ve yarıçap bilgisi uygulamanın cihaza özel depolama alanında yerel olarak tutulur.",
    subWatchItem1: "Depolama Android uygulama sandbox'ı içindeki yerel veri yapılarındadır.",
    subWatchItem2: "Bu veriler app-level encrypted değildir.",
    subWatchItem3: "Watch-zone verileri herhangi bir uzak hesap veya backend hizmetine yüklenmez.",
    ...
    notCollectedSensitiveBody: "Precise location, background location, kamera, mikrofon ve medya verisi işlenmez.",
    notCollectedCommercialTitle: "Ticari izleme verileri",
    notCollectedCommercialBody: "Reklam tanımlayıcıları, analytics SDK verileri, ödeme bilgileri ve IAP verileri yoktur.",
    notCollectedSocialTitle: "Sosyal içerik",
    notCollectedSocialBody: "UGC, sosyal paylaşım, kişi listesi, takvim veya çağrı verisi toplanmaz.",
